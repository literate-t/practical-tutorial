...
export default class App {
  ...
  private initialize = () => {
    ...
    idField.addValidateRule(DoesContainWhiteSpace);
    idField.addValidateRule(DoesStartWithNumber);
    idField.addValidateRule(MinimumLengthLimit(3));

    emailField.addValidateRule(DoesContainWhiteSpace);
